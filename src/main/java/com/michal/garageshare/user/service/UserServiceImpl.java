...
import com.michal.garageshare.common.generic.service.AbstractServiceImpl;
import com.michal.garageshare.common.util.RandomUtil;
...
@Service
@Transactional
public class UserServiceImpl extends AbstractServiceImpl<UserEntity, UserDTO, Long> implements UserService {
    ...
    public UserEntity createUser(UserDTO userDTO) {
        ...
        log.debug("Created Information for UserEntity: {}", user);
        return user;
    }
